...
<title>MemoXpress Inc - Properties</title>
...
<script type="text/template" id="modal-property-tpl">
	<form id="frm-mdl-property" name="frm-mdl-property" class="table-model" data-table="property" action="" method="post">	
        	...
        	<tbody>
				...
				<tr>
                    ...
                    <td>
                        ...
                        <select name="propcatid" id="propcatid" class="m-input">
                        <?php
                           
                            
                            $matcats = Propcat::find_all();
				...
				<tr>
                    ...
                    <td><input type="number" name="ordinal" id="ordinal" maxlength="5" value="<%= ordinal %>"></td>
         		</tr>
        	</tbody>
    	</table>
 	</form>
...
<script type="text/template" id="modal-property-readonly-tpl">
    ...
    <table cellpadding="5px" cellspacing="0" border="0">
            <tbody>
                ...
                <tr>
                    <td><label for="propcat">Category: </label></td>
                    <td><input type="text" name="propcat" id="propcat" maxlength="20" class="m-input"  value="<%= propcat %>"  readonly>     </td>
                </tr>
        		<tr>
                	<td><label for="ordinal">Ordinal:</label></td>
                    <td><input type="number" name="ordinal" id="ordinal" maxlength="5" value="<%= ordinal %>" readonly></td>
         		</tr>
            </tbody>
        </table>
    </form>
...
$(document).ready(function(e) {
	...
	var propertyModal = new PropertyModal({ model: property });
	propertyModal.render();
	//console.log(itemcatModalView.el);
	var propertyDataGridView = new DataGridView({model: property });

	$('#tlbr-new').on('click', function(){
		//$(".modal .modal-title").text('Add');
		propertyModal.modalTitle.text('Add Record');
		propertyModal.clearForm();
	...
	//	"sAjaxSource": "../www/test/datatable_test.php"
		...
		"aoColumns": [
            ...
            { "mData": "propcat",  "sTitle": "Category" },
			{ "mData": "ordinal",  "sTitle": "Ordinal" }
			],
        	...
        	<nav class="main-nav">
            	<div id="menu0" class="nav active">
                    ...
                    <ul class="fd">
                        ...
                        <li class="active"><a href="property">Properties</a></li>
