...
<title>MemoXpress Inc - Product Category</title>
...
$(document).ready(function(e) {
	...
	var prodcatModalView = new ProdcatModal({ model: prodcat});
	prodcatModalView.render();
	var matcatDataGridView = new DataGridView({model: prodcat});

	$('#tlbr-new').on('click', function(){
		//$(".modal .modal-title").text('Add');
		prodcatModalView.modalTitle.text('Add Record');
		prodcatModalView.clearForm();
	...
	oTable = $('.tb-data').dataTable( {
		...
		"bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "../api/datatables/prodcat",
