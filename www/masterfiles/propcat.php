...
<title>MemoXpress Inc - Property Category</title>
...
<script type="text/template" id="modal-propcat-tpl">
	<form id="frm-mdl-propcat" name="frm-mdl-propcat" class="table-model" data-table="propcat" action="" method="post">	
...
<script type="text/template" id="modal-propcat-readonly-tpl">
	<table cellpadding="5px" cellspacing="0" border="0">
	<tbody>
		<tr>
			<td>Code:</td>
...
$(document).ready(function(e) {
	...
	var propcatModalView = new PropcatModal({ model: propcat});
	propcatModalView.render();

	var propcatDataGridView = new DataGridView({model: propcat});

	$('#tlbr-new').on('click', function(){
		//$(".modal .modal-title").text('Add');
		propcatModalView.modalTitle.text('Add Record');
		propcatModalView.clearForm();
        	...
        	<nav class="main-nav">
            	<div id="menu0" class="nav active">
                    ...
                    <ul class="fd">
                        ...
                        <li class="active"><a href="propcat">Properties Category</a></li>
