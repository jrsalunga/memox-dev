...
<title>MemoXpress Inc - Brand</title>
...
<script type="text/template" id="modal-brand-tpl">
...
$(document).ready(function(e) {
	...
	var brandModalView = new BrandModal({ model: brand});
	brandModalView.render();
	var brandDataGridView = new DataGridView({model: brand});

	$('#tlbr-new').on('click', function(){
		//$(".modal .modal-title").text('Add');
		brandModalView.modalTitle.text('Add Record');
		brandModalView.clearForm();
